...
def get_engine_url_from_env():
    """Extract SQLAlchemy engine URL configuration from environment variables.

    It uses following env vars:
    - DB_ADAPTER: database connector adapter
